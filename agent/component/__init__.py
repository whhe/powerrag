...
def component_class(class_name):
    for module_name in ["agent.component", "agent.tools", "rag.flow", "powerrag.flow.parsers", "powerrag.flow.splitters", "powerrag.flow.extractors", "powerrag.flow.converters"]:
        try:
